...
class ScriptArguments:
    ...
    train_set_path: Optional[str] = field(
        #default="ZhangShenao/gemma_gsm8k_rational_answer",
        default="/home/cyc2202/LLM-as-Latent-Variable-Model/sample_output.jsonl",
        metadata={"help": "The dir of the subset of the training data to use"},
    )
    output_dir: Optional[str] = field(
        default="./outputs/restem_6epoch",
...
#    return sample
def cot_prefix(sample):
    sample["prompt"] = 'Question: ' + sample["Question"]
    sample["completion"] = sample["Answers"][0]
    return sample
